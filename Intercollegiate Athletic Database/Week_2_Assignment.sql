...
(
    ...
    FACNO VARCHAR(8) NOT NULL,
    DATEAUTH DATE ,
    STATUS VARCHAR(50) NOT NULL CHECK ('Pending' OR 'Denined' OR 'Approved'),
...
ALTER TABLE LOCATION ADD constraint FK_FACNO_LOCATION FOREIGN KEY (FACNO) REFERENCES FACILITY(FACNO);

ALTER TABLE EVENTREQUEST ADD CONSTRAINT FK_CUSTNO_EVENTREQUEST  FOREIGN KEY (CUSTNO) REFERENCES CUSTOMER (CUSTNO);
ALTER TABLE EVENTREQUEST ADD CONSTRAINT FK_FACNO_EVENTREQUEST FOREIGN KEY(FACNO) REFERENCES FACILITY (FACNO);

ALTER TABLE EVENTPLAN ADD CONSTRAINT FK_EVENTNO_EVENTPLAN FOREIGN KEY(EVENTNO) REFERENCES EVENTREQUEST(EVENTNO);
ALTER TABLE EVENTPLAN ADD  CONSTRAINT FK_EMPNO_EVENTPLAN FOREIGN KEY (EMPNO) REFERENCES EMPLOYEE(EMPNO) ;

ALTER TABLE EVENTPLANLINE ADD CONSTRAINT FK_LOCNO_EVENTPLANLINE FOREIGN KEY(LOCNO) REFERENCES LOCATION (LOCNO);
ALTER TABLE EVENTPLANLINE ADD CONSTRAINT FK_RESNO_EVENTPLANLINE FOREIGN KEY(RESNO) REFERENCES RESOURCETBL(RESNO) ;
ALTER TABLE EVENTPLANLINE ADD CONSTRAINT FK_PLANNO_EVENTPLANLINE FOREIGN KEY(PLANNO) REFERENCES EVENTPLAN(PLANNO) ;
